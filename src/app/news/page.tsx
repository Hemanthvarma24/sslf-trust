    ...
    <section className="py-10 md:py-16 bg-white">
      <div className="container mx-auto px-4 pt-[60px]">
        <div className="relative text-center mb-8">
          <h2 className="absolute inset-0 flex items-center justify-center text-[#0b0a45] text-2xl md:text-4xl font-bold">
            NEWS & EVENTS
          </h2>
        </div>

        {/* Centered menu container for desktop, scrollable for mobile */}
        <div className="relative mb-8 flex justify-center pb-8">
          <div
            ref={menuRef}
